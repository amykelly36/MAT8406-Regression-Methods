...
# Part (c)
# ========
summary(reg1)                           # Regression summary of full model
reg2 <- update(reg1,.~.-poor)           # Refits model without "poor" term
summary(reg2)                           # Regression summary
reg3 <- update(reg2,.~.-density)        # Refits without "density" term
summary(reg3)                           # Regression summary
reg4 <- update(reg3,.~.-logso2)         # Refits without "logso2" term
summary(reg4)                           # Regression summary
reg5 <- update(reg4,.~.-house)          # Refits without "house" term
